  ...
  return (
    <section ref={ref} className="pt-24 md:pt-[150px]" id="about">
      ...
      <div className="grid grid-cols-1 antialiased gap-6 text-white/80 text-lg md:text-xl mt-8 leading-[34px] md:leading-[39px]">
        <AnimatedBody>
          2023年，我在阿里国际站学习店铺运营，没有特别的成就。直到半年后，公司人员变动，有运营经验的我被安排到了独立站SEO的岗位上。是的，一开始并不是我主动选择，更像是被推着上路的。
        </AnimatedBody>
        <AnimatedBody>
          我负责了一部分代运营的相关工作，对当时的我来说，这是一个很新的领域。好消息是，跟着团队学习下，所有合同都顺利交付，所有指定关键词也成功进入首页Top10，自己也得到了领导的肯定和嘉奖，获得了首次除工资以外的奖金。
        </AnimatedBody>
        <AnimatedBody>
